grep '174008' gene_all_transcripts.gtf | sed 's/ENSMUST00000174008/a/g' > gene.gtf;
...
python ../sashimi-plot.py -b bams.txt -c chr9:21616129-21632827 -g gene.gtf -o sashimi_shrinked -P color.txt -O 3 -C 3 -M 300 --width=8 --ann-height=0.5 --height=1.5 --base-size=16 --alpha=1.0 -F png --shrink
