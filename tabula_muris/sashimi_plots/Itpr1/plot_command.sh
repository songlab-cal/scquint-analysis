cat gene_all_transcripts.gtf | grep "ENSMUST00000203615" | sed 's/ENSMUST00000203615/a/g' > gene.gtf;
...
python ../sashimi-plot.py -b bams.txt -c chr6:108493606-108499280 -g gene.gtf -o sashimi_shrinked -P color.txt -O 3 -C 3 -M 160 --width=3.5 --ann-height=0.3 --height=1.3 --base-size=7.3 --alpha=1.0 -F png --shrink
