grep '088419\|167459\|227153' gene_all_transcripts.gtf | sed 's/ENSMUST00000088419/a/g' | sed 's/ENSMUST00000167459/b/g' | sed 's/ENSMUST00000227153/c/g' > gene.gtf;
...
python ../sashimi-plot.py -b bams.txt -c chr14:120396359-120428953 -g gene.gtf -o sashimi_shrinked -P color.txt -O 3 -C 3 -M 100 --width=6 --ann-height=0.7 --height=2.0 --base-size=16 --alpha=1.0 -F png --shrink
