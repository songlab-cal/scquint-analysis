grep '230847' gene_all_transcripts.gtf | sed 's/ENSMUST00000230847/a/g' > gene.gtf;
...
python ../sashimi-plot.py -b bams.txt -c chr15:68928631-68995207 -g gene.gtf -o sashimi_shrinked -P color.txt -O 3 -C 3 -M 500 --width=5 --ann-height=0.5 --height=1.5 --base-size=16 --alpha=1.0 -F png --shrink
